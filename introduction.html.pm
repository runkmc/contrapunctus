...
introduction to modal counterpoint for the beginner. It does assume that the reader has some familiarity with musical concepts, but it does not assume familiarity with counterpoint.}
	◊p{This
	...
	it attempts to briefly provide the perspective that an instructor might provide in a classroom setting. I have
