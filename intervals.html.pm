...
◊main-section{
	...
	familiar with the notes of the ◊term{staff} with a ◊term{treble clef:}}
...
◊main-section{
	...
	◊p{An ◊term{interval} is the distance between two pitches. Being able to figure
...
◊main-section{
	...
	pitches that are separated by an interval of two form a ◊term{second,}
	pitches that form an interval of three are called a ◊term{third,} and so on, up to
	an ◊term{eleventh} and a ◊term{twelfth} in the above example. There are two
	exceptions to this rule. Identical pitches (that is, pitches with an interval 
	of one) are usually referred to as a ◊term{unison}, and pitches separated by an
	interval of eight are referred to as an ◊term{octave.}}
	}
◊main-section{
